...
from base.forms import ModelForm as PetabytzModelForm
...
from horilla_widgets.widgets.horilla_multi_select_field import PetabytzMultiSelectField
from horilla_widgets.widgets.select_widgets import PetabytzMultiSelectWidget
...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = PetabytzMultiSelectField(
            queryset=Employee.objects.all(),
            widget=PetabytzMultiSelectWidget(
        ...
        self.fields["managers"] = PetabytzMultiSelectField(
            queryset=Employee.objects.all(),
            widget=PetabytzMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        for field_name, field_instance in self.fields.items():
            if isinstance(field_instance, PetabytzMultiSelectField):
...
class KRForm(PetabytzModelForm):
    """
...
class FeedbackForm(PetabytzModelForm):
    """
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # Petabytz multi-select filter for subordinates
        # self.fields["subordinate_id"] = PetabytzMultiSelectField(
        #     queryset=Employee.objects.all(),
        #     widget=PetabytzMultiSelectWidget(
        #         filter_route_name="employee-widget-filter",
        #         filter_class=EmployeeFilter,
...
class PeriodForm(PetabytzModelForm):
    """
...
class MeetingsForm(BaseForm):
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], PetabytzMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_id"] = PetabytzMultiSelectField(
...
class BonusPointSettingForm(PetabytzModelForm):
    """
...
class EmployeeBonusPointForm(PetabytzModelForm):
    """
...
class EmployeeFeedbackForm(PetabytzModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["others_id"] = PetabytzMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=PetabytzMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["others_id"], PetabytzMultiSelectField):
...
class BulkFeedbackForm(PetabytzModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields["employee_ids"] = PetabytzMultiSelectField(
            queryset=Employee.objects.filter(employee_work_info__isnull=False),
            widget=PetabytzMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
    ...
    def clean(self):
        cleaned_data = super().clean()
        if isinstance(self.fields["employee_ids"], PetabytzMultiSelectField):
