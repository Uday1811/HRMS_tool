...
class ToggleColumn(PetabytzModel):
    """
    ToggleColumn
    """
...
class ActiveGroup(PetabytzModel):
    """
    ActiveGroup
    """
...
class SavedFilter(PetabytzModel):
    """
    SavedFilter
    """
...
class ActiveView(PetabytzModel):
    """
