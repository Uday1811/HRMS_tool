...
class Offboarding(PetabytzModel):
    """
    Offboarding model
    """
...
class OffboardingStage(PetabytzModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(PetabytzModel):
    """
...
class OffboardingEmployee(PetabytzModel):
    """
...
class ResignationLetter(PetabytzModel):
    """
...
class OffboardingTask(PetabytzModel):
    """
...
class EmployeeTask(PetabytzModel):
    """
    EmployeeTask model
    """
...
class ExitReason(PetabytzModel):
    """
    ExitReason model
    """
...
class OffboardingNote(PetabytzModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(PetabytzModel):
    """
