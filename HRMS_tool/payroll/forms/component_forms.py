...
from horilla_widgets.forms import PetabytzForm, default_select_option_template
...
class AllowanceForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = PetabytzMultiSelectField(
...
class GeneratePayslipForm(PetabytzForm):
    """
    Form for Payslip
    """
