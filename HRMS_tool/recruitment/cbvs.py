...
class LinkedinSettingSectionView(views.PetabytzSectionView):
    """
...
class LinkedInSettingNavView(views.PetabytzNavView):
    """
...
class LinkedInAccountFormView(views.PetabytzFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.PetabytzListView):
    """
