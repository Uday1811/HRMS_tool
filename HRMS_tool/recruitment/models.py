...
class SurveyTemplate(PetabytzModel):
    """
...
class Recruitment(PetabytzModel):
    """
    Recruitment model
    """
...
class Stage(PetabytzModel):
    ...
    objects = PetabytzCompanyManager(related_company_field="recruitment_id__company_id")
...
class RejectReason(PetabytzModel):
    """
    RejectReason
    """
...
class RejectedCandidate(PetabytzModel):
    """
    RejectedCandidate
    """
...
class StageFiles(PetabytzModel):
...
class RecruitmentSurvey(PetabytzModel):
    """
    ...
    objects = PetabytzCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(PetabytzModel):
    """
...
class RecruitmentSurveyAnswer(PetabytzModel):
    """
...
class SkillZoneCandidate(PetabytzModel):
    """
...
class CandidateRating(PetabytzModel):
...
class RecruitmentGeneralSetting(PetabytzModel):
    """
...
class InterviewSchedule(PetabytzModel):
    """
    ...
    objects = PetabytzCompanyManager("candidate_id__recruitment_id__company_id")
...
class CandidateDocumentRequest(PetabytzModel):
    title = models.CharField(max_length=100)
...
class CandidateDocument(PetabytzModel):
...
class LinkedInAccount(PetabytzModel):
