...
@method_decorator(login_required, name="dispatch")
class TaskListView(PetabytzListView):
    """
...
@method_decorator(login_required, name="dispatch")
class TasksNavBar(PetabytzNavView):
    """
    navbar of teh page
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCreateForm(PetabytzFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskDetailView(PetabytzDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class TaskCardView(PetabytzCardView):
    """
