...
class TimeSheetNavView(PetabytzNavView):
    """
    Nav bar
    """
...
class TimeSheetList(PetabytzListView):
    """
...
class TaskTimeSheet(TimeSheetList):
    ...
    def get_queryset(self):
        queryset = PetabytzListView.get_queryset(self)
        task_id = self.kwargs.get("task_id")
...
class TimeSheetFormView(PetabytzFormView):
    """
...
class TimeSheetCardView(PetabytzCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(PetabytzDetailedView):
    """
