...
class ProjectStage(PetabytzModel):
    """
    ProjectStage model
    """
    ...
    objects = PetabytzCompanyManager("project__company_id")
...
class TimeSheet(PetabytzModel):
    ...
    objects = PetabytzCompanyManager("project_id__company_id")
