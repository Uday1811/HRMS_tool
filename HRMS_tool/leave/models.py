...
class CompanyLeave(PetabytzModel):
...
class AvailableLeave(PetabytzModel):
...
class LeaveRequest(PetabytzModel):
    employee_id = models.ForeignKey(
...
class LeaverequestComment(PetabytzModel):
    """
...
class LeaveAllocationRequest(PetabytzModel):
    leave_type_id = models.ForeignKey(
        LeaveType, on_delete=models.PROTECT, verbose_name=_("Leave type")
    )
    employee_id = models.ForeignKey(
...
class LeaveallocationrequestComment(PetabytzModel):
    """
...
class RestrictLeave(PetabytzModel):
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(PetabytzModel):
        leave_type_id = models.ForeignKey(
...
class LeaveGeneralSetting(PetabytzModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(PetabytzModel):
        """
...
class EmployeePastLeaveRestrict(PetabytzModel):
