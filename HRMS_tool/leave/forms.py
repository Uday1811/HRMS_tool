"""
This module provides Petabytz ModelForms for creating and managing leave-related data,
...
from horilla_widgets.forms import PetabytzForm, PetabytzModelForm
...
class LeaveTypeForm(ConditionForm):
    ...
    employee_id = PetabytzMultiSelectField(
...
class LeaveOneAssignForm(PetabytzModelForm):
    """
    ...
    Attributes:
        - employee_id: A PetabytzMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(PetabytzForm):
    """
    Form for Payslip
    """
