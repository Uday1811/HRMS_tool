...
class PetabytzAuditInfo(models.Model):
    """
    PetabytzAuditInfo model to store additional info
    """
...
def post_create_horilla_audit_log(sender, instance, *_args, **kwargs):
    ...
    try:
        ...
        if isinstance(history_instance, PetabytzAuditLog):
