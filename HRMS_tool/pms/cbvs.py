...
class BonusPointSettingSectionView(views.PetabytzSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.PetabytzNavView):
    """
...
class BonusPointSettingFormView(views.PetabytzFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.PetabytzListView):
    """
...
class EmployeeBonusPointSectionView(views.PetabytzSectionView):
    """
...
class EmployeeBonusPointNavView(views.PetabytzNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.PetabytzFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.PetabytzListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.PetabytzFormView):
    """
...
class BulkFeedbackFormView(views.PetabytzFormView):
    """
    Feedback other employee form View
    """
