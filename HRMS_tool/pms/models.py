...
class KeyResult(PetabytzModel):
    ...
    history = PetabytzAuditLog(bases=[PetabytzAuditInfo])
...
class EmployeeObjective(PetabytzModel):
    ...
    history = PetabytzAuditLog(bases=[PetabytzAuditInfo], related_name="history_set")
    archive = models.BooleanField(default=False)
...
class Comment(models.Model):
    ...
    history = PetabytzAuditLog(excluded_fields=["comment"], bases=[PetabytzAuditInfo])
    objects = PetabytzCompanyManager(
...
class QuestionTemplate(PetabytzModel):
...
class Question(PetabytzModel):
    ...
    objects = PetabytzCompanyManager("template_id__company_id")

    def __str__(self):
        return self.question


class QuestionOptions(PetabytzModel):
    ...
    objects = PetabytzCompanyManager("question_id__template_id__company_id")


class Feedback(PetabytzModel):
...
class EmployeeBonusPoint(PetabytzModel):
    employee_id = models.ForeignKey(
        Employee,
        on_delete=models.DO_NOTHING,
