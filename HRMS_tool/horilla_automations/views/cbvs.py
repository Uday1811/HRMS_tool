...
from base.models import PetabytzMailTemplate
...
class AutomationSectionView(views.PetabytzSectionView):
    """
...
class AutomationNavView(views.PetabytzNavView):
    """
    AutomationNavView
    """
...
class AutomationFormView(views.PetabytzFormView):
    """
    AutomationFormView
    """
...
class AutomationListView(views.PetabytzListView):
    """
    AutomationListView
    """
...
class AutomationDetailedView(views.PetabytzDetailedView):
    """
    ...
    def post(self, request):
        ...
        for template_json in templates_raw:
            if template_json["pk"] in required_template_pks:
                ...
                existing = PetabytzMailTemplate.objects.filter(
        ...
        for automation_json in selected_automations:
            ...
            mail_template = PetabytzMailTemplate.objects.filter(
                body=template_body
            ).first()
