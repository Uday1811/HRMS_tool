...
This module defines the abstract base model `PetabytzModel` for the Petabytz HRMS project.
The `PetabytzModel` provides common fields and functionalities for other models within
...
class PetabytzModel(models.Model):
    """
    An abstract base model that includes common fields and functionalities
    for models within the Petabytz application.
    """
    ...
    def save(self, *args, **kwargs):
        ...
        super(PetabytzModel, self).save(*args, **kwargs)
...
auditlog.register(PetabytzModel, serialize_data=True)
