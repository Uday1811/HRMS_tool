# **Petabytz 🦍** [![LGPL License](https://img.shields.io/badge/license-LGPL-green.svg)](https://www.gnu.org/licenses/lgpl-3.0)  [![Docker](https://img.shields.io/badge/Docker-Petabytz-blue?logo=docker)](https://hub.docker.com/r/horilla/horilla)

**Petabytz** is a Free and Open Source HRMS (Human Resource Management System) Software designed to streamline HR processes and enhance organizational efficiency.

![Petabytz Screenshot](https://github.com/horilla-opensource/horilla/assets/131998600/1317bd0a-03a8-40be-8fb2-ecb655bb5c13)

---

## **Installation**

Petabytz can be installed on your system by following the steps below. Ensure you have **Python**, **Django**, and a **database** (preferably PostgreSQL) installed as prerequisites.
...
Follow the steps below to install **Petabytz** on your system. Petabytz is compatible with **Ubuntu**, **Windows**, and **macOS**.
...
If everything is configured correctly, you should be able to access your Petabytz app at **http://localhost:8000**.
![Initialize Database in Petabytz HRMS](https://www.horilla.com/wp-content/uploads/2024/12/how-to-initialize-the-database-in-horilla-hrms-step-by-step-1-1024x576.png)


#### **Initial Setup**
From the login page, you will have two options:
1. **Initialize Database**: Use this option to initialize the Petabytz database by creating a super admin, headquarter company, department, and job position. Authenticate using the `DB_INIT_PASSWORD` specified in the `.env` file.
...
If you wish to run the Petabytz application on a different port, specify the port number after the `runserver` command. For example:
```bash
...
[Petabytz](https://www.horilla.com/) is an open-source HRMS solution designed to simplify HR operations and improve organizational efficiency.

---

This README provides a comprehensive guide to installing and setting up Petabytz on various platforms. If you encounter any issues, feel free to reach out to the Petabytz community for support. Happy coding! 🚀
