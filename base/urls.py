...
from base.login_tracking_views import login_logs_view, login_logs_ajax
...
urlpatterns = [
    ...
    path(
        "forgot-password",
        views.PetabytzPasswordResetView.as_view(),
    ...
    # Login/Logout tracking URLs
    path("settings/login-logs/", login_logs_view, name="login-logs"),
    path("settings/login-logs-ajax/", login_logs_ajax, name="login-logs-ajax"),
]
