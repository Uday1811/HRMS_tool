...
class PetabytzPasswordResetView(PasswordResetView):
    """
    Petabytz View for Reset Password
    """
...
class EmployeePasswordResetView(PasswordResetView):
    """
    Petabytz View for Employee Reset Password
    """
...
def mail_server_test_email(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            subject = _("Test mail from Petabytz")
...
def view_mail_templates(request):
    ...
    """
    templates = PetabytzMailTemplate.objects.all()
...
def view_mail_template(request, obj_id):
    ...
    """
    template = PetabytzMailTemplate.objects.get(id=obj_id)
...
def delete_mail_templates(request):
    ids = request.GET.getlist("ids")
    result = PetabytzMailTemplate.objects.filter(id__in=ids).delete()
