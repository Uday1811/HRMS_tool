...
class AssignPermission(Form):
    ...
    employee = PetabytzMultiSelectField(
...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = PetabytzMultiSelectField(
...
class AnnouncementForm(ModelForm):
    ...
    employees = PetabytzMultiSelectField(
        queryset=Employee.objects.all(),
        widget=PetabytzMultiSelectWidget(
            filter_route_name="employee-widget-filter",
            filter_class=EmployeeFilter,
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employees"], PetabytzMultiSelectField):
