...
from base.models import PetabytzMailTemplate, JobPosition
...
def candidates_view(request):
    ...
    mail_templates = PetabytzMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        PetabytzMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
