...
class OnboardingStage(PetabytzModel):
    """
    ...
    objects = PetabytzCompanyManager("recruitment_id__company_id")
...
class OnboardingTask(PetabytzModel):
    """
    ...
    objects = PetabytzCompanyManager("stage_id__recruitment_id__company_id")
...
class CandidateStage(PetabytzModel):
    """
...
class CandidateTask(PetabytzModel):
    """
    CandidateTask model
    """
...
class OnboardingPortal(PetabytzModel):
    """
