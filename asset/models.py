...
class AssetCategory(PetabytzModel):
    """
...
class Asset(PetabytzModel):
    ...
    objects = PetabytzCompanyManager("asset_category_id__company_id")
...
class AssetReport(PetabytzModel):
    """
...
class AssetDocuments(PetabytzModel):
    """
...
class ReturnImages(PetabytzModel):
    """
...
class AssetAssignment(PetabytzModel):
    """
    ...
    objects = PetabytzCompanyManager("asset_id__asset_lot_number_id__company_id")
...
class AssetRequest(PetabytzModel):
    """
