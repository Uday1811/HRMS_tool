...
from horilla_views.generic.cbv.views import PetabytzDetailedView, PetabytzListView
...
class ProjectsDueInMonth(PetabytzListView):
...
class ProjectDetailView(PetabytzDetailedView):
    """
