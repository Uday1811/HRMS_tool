...
from horilla.filters import FilterSet, PetabytzFilterSet, filter_by_name

from .models import Employee, Project, Task, TimeSheet


class ProjectFilter(PetabytzFilterSet):
...
class TaskAllFilter(PetabytzFilterSet):
    search = django_filters.CharFilter(method="filter_by_task")
    end_till = django_filters.DateFilter(
        field_name="end_date",
        lookup_expr="lte",
...
class TimeSheetFilter(PetabytzFilterSet):
    """
