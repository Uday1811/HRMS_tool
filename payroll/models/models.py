...
class FilingStatus(PetabytzModel):
    """
    FilingStatus model
    """
...
class LoanAccount(PetabytzModel):
    """
...
class Reimbursement(PetabytzModel):
    """
    Reimbursement Model
    """
...
class ReimbursementrequestComment(PetabytzModel):
    """
...
class EmployeePayslip(models.Model):
    employee = models.ForeignKey(Employee, on_delete=models.CASCADE, related_name='employee_payslips')
    pay_period = models.DateField(help_text='The month/year this payslip belongs to')
    document = models.FileField(upload_to='payslips/')
