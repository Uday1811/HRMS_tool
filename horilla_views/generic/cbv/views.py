...
class PetabytzListView(ListView):
    """
    PetabytzListView
    """
    ...
    def serve_import_sheet(self, request, *args, **kwargs):
        ...
        if not self.import_accessibility():
            ...
            return PetabytzFormView.HttpResponse()
    ...
    def get_context_data(self, **kwargs: Any):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[PetabytzListView] = context
    ...
    def export_data(self, *args, **kwargs):
        ...
        class PetabytzListViewResorce(resources.ModelResource):
            """
        ...
        book_resource = PetabytzListViewResorce()
...
class PetabytzSectionView(TemplateView):
    """
    Petabytz Template View
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, PetabytzListView)
...
@method_decorator(hx_request_required, name="dispatch")
class PetabytzDetailedView(DetailView):
    """
    HorillDetailedView
    """
    ...
    header: dict = {
        "title": "Petabytz",
        "subtitle": "Petabytz Detailed View",
        "avatar": "",
    }
    body: list = []
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, PetabytzDetailedView)
...
@method_decorator(hx_request_required, name="dispatch")
class PetabytzTabView(TemplateView):
    """
    PetabytzTabView
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.query_params = {}
        # update_initial_cache(request, CACHE, PetabytzTabView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[PetabytzTabView] = context

        return context


@method_decorator(hx_request_required, name="dispatch")
class PetabytzCardView(ListView):
    """
    PetabytzCardView
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, PetabytzCardView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[PetabytzCardView] = context
        referrer = self.request.GET.get("referrer", "")
        if referrer:
            # Remove the protocol and domain part
            referrer = "/" + "/".join(referrer.split("/")[3:])
...
@method_decorator(hx_request_required, name="dispatch")
class PetabytzFormView(FormView):
    """
    PetabytzFormView
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        # update_initial_cache(request, CACHE, PetabytzFormView)
    ...
    def get_form(self, form_class=None):
        ...
        if not hasattr(self, "form"):
            ...
            # CACHE.get(self.request.session.session_key + "cbv")[PetabytzFormView] = form
            self.form = form
        return self.form
...
@method_decorator(hx_request_required, name="dispatch")
class PetabytzNavView(TemplateView):
    """
    PetabytzNavView
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        request = getattr(_thread_locals, "request", None)
        self.request = request
        # update_initial_cache(request, CACHE, PetabytzNavView)
    ...
    def get_context_data(self, **kwargs):
        ...
        # CACHE.get(self.request.session.session_key + "cbv")[PetabytzNavView] = context
        return context
...
@method_decorator(hx_request_required, name="dispatch")
class PetabytzProfileView(DetailView):
    """
    GenericPetabytzProfileView
    """
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.request = request
        self.ordered_ids_key = f"ordered_ids_{self.model.__name__.lower()}"
        # update_initial_cache(request, CACHE, PetabytzProfileView)
