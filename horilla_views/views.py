...
from horilla_views.generic.cbv.views import PetabytzFormView, PetabytzListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.PetabytzModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(PetabytzFormView):
    """
    SavedFilter
    """
...
class DynamiListView(PetabytzListView):
    """
...
class PetabytzDeleteConfirmationView(View):
    """
