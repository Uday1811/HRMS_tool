...
urlpatterns = [
    ...
    path("home/", views_home.home_dashboard, name="home-dashboard"),
    ...
    path("api/leave/cancel/<int:request_id>/", views.cancel_leave_api, name="cancel-leave-api"),
    path("api/leave/approve/<int:request_id>/", views.approve_leave_api, name="approve-leave-api"),
    path("api/leave/reject/<int:request_id>/", views.reject_leave_api, name="reject-leave-api"),
