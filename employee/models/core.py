...
from horilla.models import PetabytzModel, has_xss, upload_path
from horilla_audit.methods import get_diff
from horilla_audit.models import PetabytzAuditInfo, PetabytzAuditLog
# import removed for refactoring
...
class Employee(models.Model):
    ...
    # Enable strict multi-tenant isolation
    objects = PetabytzCompanyManager()
    
    @classmethod
    def get_company_filter(cls, company_id):
        from django.db.models import Q
        return Q(employee_work_info__company_id=company_id)
...
class EmployeeTag(PetabytzModel):
    """
    EmployeeTag Model
    """
...
class EmployeeBankDetails(PetabytzModel):
    """
...
class EmployeeNote(PetabytzModel):
    """
    EmployeeNote model
    """
...
class PolicyMultipleFile(PetabytzModel):
    """
...
class BonusPoint(PetabytzModel):
    """
...
class Actiontype(PetabytzModel):
    """
    Action type model
    """
...
class DisciplinaryAction(PetabytzModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(PetabytzModel):
    """
...
class ProfileEditFeature(PetabytzModel):
    """
    ProfileEditFeature
    """
