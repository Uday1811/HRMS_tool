...
class AttendanceActivity(PetabytzModel):
    """
...
class BatchAttendance(PetabytzModel):
    """
...
class Attendance(PetabytzModel):
    """
    Attendance model
    """
    ...
    def get_first_clock_in_activity(self):
        """
        This method is used to get the first attendance activity (Clock In)
        """
...
class AttendanceRequestFile(PetabytzModel):
    file = models.FileField(upload_to=upload_path)


class AttendanceRequestComment(PetabytzModel):
    """
...
class AttendanceOverTime(PetabytzModel):
    """
...
class AttendanceLateComeEarlyOut(PetabytzModel):
    """
...
class AttendanceValidationCondition(PetabytzModel):
    """
...
class AttendanceGeneralSetting(PetabytzModel):
    """
