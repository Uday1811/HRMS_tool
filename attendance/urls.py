...
urlpatterns = [
    ...
    path("ajax-clock/", views.ajax_clock, name="ajax-clock"),
    ...
    path("attendance-clock-in", attendance.views.clock_in_out.clock_in, name="attendance-clock-in"),
    path("clock-out", attendance.views.clock_in_out.clock_out, name="clock-out"),
    path("attendance-clock-out", attendance.views.clock_in_out.clock_out, name="attendance-clock-out"),
    path("render-clock-widget", attendance.views.clock_in_out.render_clock_widget, name="render-clock-widget"),
