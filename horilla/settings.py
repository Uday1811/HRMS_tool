...
MIDDLEWARE = [
    ...
    # Multi-tenant middleware - must come after AuthenticationMiddleware
    "base.multi_tenant_middleware.MultiTenantMiddleware",
    "base.multi_tenant_middleware.CompanyIsolationMiddleware",
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "base.context_processors.company_context",
            ],
        },
    },
]
...
# Authentication backends - supports Employee ID login
AUTHENTICATION_BACKENDS = [
    'base.employee_auth_backend.EmployeeIDAuthenticationBackend',
